        ...
        Scaffold(
            ...
            when (currentDestination) {
                AppDestination.GAME_NIGHT -> DashboardScreen(
                    ...
                    onBeginCancelGameNight = dashboardViewModel::beginCancelGameNight,
                    onCancelReasonChange = dashboardViewModel::updateCancelReason,
                    onConfirmCancelGameNight = dashboardViewModel::confirmCancelGameNight,
                    onDismissCancelGameNight = dashboardViewModel::dismissCancelGameNight,
