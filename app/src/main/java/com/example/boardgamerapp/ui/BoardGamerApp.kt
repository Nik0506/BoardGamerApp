        ...
        Scaffold(
            ...
            when (currentDestination) {
                AppDestination.GAME_NIGHT -> DashboardScreen(
                    ...
                    onBeginDeclineAttendance = dashboardViewModel::beginDeclineAttendance,
                    onDeclineReasonChange = dashboardViewModel::updateDeclineReason,
                    onConfirmDeclineAttendance = dashboardViewModel::confirmDeclineAttendance,
                    onDismissDeclineAttendance = dashboardViewModel::dismissDeclineAttendance,
